...
| 0035 | [Exposing OpenCode Sessions in Task Status](0035-task-session-integration.md) | Phase 1 (session ID) + Phase 3 (session summary/token usage) implemented; Phase 2 (session proxy API) pending |
...
| 0039 | [KubePi Feasibility Analysis — Pi as Alternative Agent Runtime](0039-kubepi-feasibility-analysis.md) | 2026-05-06 |
...
| 0013 | [Defer Token Usage Tracking to Post-v0.1](0013-defer-token-usage-tracking.md) | [ADR 0035](0035-task-session-integration.md) |
...
| 0023 | [Agent Idle Timeout for Auto-Suspend/Auto-Resume](0023-agent-idle-timeout.md) | [ADR 0024](0024-agent-standby.md) |
